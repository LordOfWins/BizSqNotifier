...
namespace BizSqNotifier
{
    ...
    public partial class RenewalListForm : Form
    {
        ...
        private void OnFormLoad(object sender, EventArgs e) { LoadAll(); }
        ...
        private void LoadAll()
        {
            ...
            {
                // 오피스 (N인실) — 33일 이내
                var officeTargets = new RenewalManualService()
                    .GetRenewalTargets(UserSettings.Current.RenewalManualDays);
                ...
                foreach (var t in officeTargets)
                {
                    ...
                    if (t.DaysUntilExpiry <= 7)
                        dgvOffice.Rows[ri].DefaultCellStyle.BackColor = Color.FromArgb(255, 253, 231);
                }
                ...
                foreach (var t in autoTargets)
                {
                    ...
                    if (t.DaysUntilExpiry <= 3)
                        dgvAdBox.Rows[ri].DefaultCellStyle.BackColor = Color.FromArgb(255, 235, 238);
                }
